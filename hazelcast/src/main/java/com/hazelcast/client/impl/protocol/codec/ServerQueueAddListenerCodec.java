 ...
 */
@Generated("dfb9ff698761b48306e739825cbcbaf5")
public final class ServerQueueAddListenerCodec {
    //hex: 0x031100
    ...
    private ServerQueueAddListenerCodec() {
    }
    ...
    public static ClientMessage encodeItemEvent(@Nullable com.hazelcast.internal.serialization.Data item, java.util.UUID uuid, int eventType) {
        ClientMessage clientMessage = ClientMessage.createForEncode();
        Frame initialFrame = new Frame(new byte[EVENT_ITEM_INITIAL_FRAME_SIZE], UNFRAGMENTED_MESSAGE);
