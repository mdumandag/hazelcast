...
public class MapMadePublishableMessageTask
        extends AbstractAllPartitionsMessageTask<ServerContinuousQueryMadePublishableCodec.RequestParameters> {
    ...
    @Override
    protected ServerContinuousQueryMadePublishableCodec.RequestParameters decodeClientMessage(ClientMessage clientMessage) {
        return ServerContinuousQueryMadePublishableCodec.decodeRequest(clientMessage);
    }

    @Override
    protected ClientMessage encodeResponse(Object response) {
        return ServerContinuousQueryMadePublishableCodec.encodeResponse((Boolean) response);
    }
