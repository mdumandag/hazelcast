 ...
 */
@Generated("315e3497d27769cc8b12d89aa00a5208")
public final class ServerMapAddPartitionLostListenerCodec {
    //hex: 0x011B00
    ...
    private ServerMapAddPartitionLostListenerCodec() {
    }
    ...
    public static ClientMessage encodeMapPartitionLostEvent(int partitionId, java.util.UUID uuid) {
        ClientMessage clientMessage = ClientMessage.createForEncode();
        Frame initialFrame = new Frame(new byte[EVENT_MAP_PARTITION_LOST_INITIAL_FRAME_SIZE], UNFRAGMENTED_MESSAGE);
