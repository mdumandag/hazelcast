 ...
 */
@Generated("e7761517621ee975a3a5395be2c96dbd")
public final class ServerClientCreateProxiesCodec {
    //hex: 0x000E00
    ...
    private ServerClientCreateProxiesCodec() {
    }
     ...
     */
    public static java.util.List<java.util.Map.Entry<String, String>> decodeRequest(ClientMessage clientMessage) {
