 ...
 */
@Generated("a416a5118f24dd2d062dffa27f558566")
public final class ServerCacheAddPartitionLostListenerCodec {
    //hex: 0x131900
    ...
    private ServerCacheAddPartitionLostListenerCodec() {
    }
    ...
    public static ClientMessage encodeCachePartitionLostEvent(int partitionId, java.util.UUID uuid) {
        ClientMessage clientMessage = ClientMessage.createForEncode();
        Frame initialFrame = new Frame(new byte[EVENT_CACHE_PARTITION_LOST_INITIAL_FRAME_SIZE], UNFRAGMENTED_MESSAGE);
