 ...
 */
public abstract class AbstractDefaultCompactReader extends AbstractCompactInternalGenericRecord implements CompactReader {

    public AbstractDefaultCompactReader(BufferObjectDataInput in, Schema schema, @Nullable Class associatedClass) {
