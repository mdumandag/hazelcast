...
public abstract class AbstractDefaultCompactWriter implements CompactWriter {
    ...
    public AbstractDefaultCompactWriter(BufferObjectDataOutput out, Schema schema) {
        this.out = out;
        this.schema = schema;
    ...
    public abstract void writeObjectInternal(BufferObjectDataOutput out, Object value) throws IOException;

    public abstract void writeGenericRecordInternal(BufferObjectDataOutput out, CompactGenericRecord value) throws IOException;
    ...
    public void writeObject(@Nonnull String fieldName, Object value) {
        writeVariableSizeField(fieldName, COMPOSED, value, this::writeObjectInternal);
    }
    ...
    public void writeGenericRecord(@Nonnull String fieldName, GenericRecord value) {
        writeVariableSizeField(fieldName, COMPOSED, value,
                (out, val) -> this.writeGenericRecordInternal(out, (CompactGenericRecord) val));
    }
    ...
    public void writeBooleanArray(@Nonnull String fieldName, boolean[] values) {
        writeVariableSizeField(fieldName, BOOLEAN_ARRAY, values, AbstractDefaultCompactWriter::writeBooleanBits);
    }
    ...
    public void writeTimeArray(@Nonnull String fieldName, LocalTime[] values) {
        writeVariableSizeField(fieldName, TIME_ARRAY, values, AbstractDefaultCompactWriter::writeLocalTimeArray0);
    }

    @Override
    public void writeDateArray(@Nonnull String fieldName, LocalDate[] values) {
        writeVariableSizeField(fieldName, DATE_ARRAY, values, AbstractDefaultCompactWriter::writeLocalDateArray0);
    }

    @Override
    public void writeTimestampArray(@Nonnull String fieldName, LocalDateTime[] values) {
        writeVariableSizeField(fieldName, TIMESTAMP_ARRAY, values, AbstractDefaultCompactWriter::writeLocalDateTimeArray0);
    }

    @Override
    public void writeTimestampWithTimezoneArray(@Nonnull String fieldName, OffsetDateTime[] values) {
        writeVariableSizeField(fieldName, TIMESTAMP_WITH_TIMEZONE_ARRAY, values, AbstractDefaultCompactWriter::writeOffsetDateTimeArray0);
    }
    ...
    public <T> void writeObjectArray(@Nonnull String fieldName, T[] values) {
        writeVariableSizeArray(fieldName, COMPOSED_ARRAY, values, this::writeObjectInternal);
    }
    ...
    public void writeGenericRecordArray(@Nonnull String fieldName, GenericRecord[] values) {
        writeVariableSizeArray(fieldName, COMPOSED_ARRAY, values,
                (out, val) -> writeGenericRecordInternal(out, (CompactGenericRecord) val));
    }
