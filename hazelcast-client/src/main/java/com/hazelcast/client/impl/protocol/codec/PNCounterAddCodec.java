 ...
 */
@Generated("7534ac0c2421aa82b58429b2270728b5")
public final class PNCounterAddCodec {
    ...
    public static ClientMessage encodeRequest(String name, long delta, boolean getBeforeUpdate, java.util.Collection<java.util.Map.Entry<java.util.UUID, Long>> replicaTimestamps, java.util.UUID targetReplicaUUID) {
