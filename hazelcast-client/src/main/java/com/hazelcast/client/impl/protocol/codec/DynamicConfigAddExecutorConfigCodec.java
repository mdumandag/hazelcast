 ...
 */
@Generated("411ab8033fbb26a932bc4ecf6f5ccab5")
public final class DynamicConfigAddExecutorConfigCodec {
    ...
    public static ClientMessage encodeRequest(String name, int poolSize, int queueCapacity, boolean statisticsEnabled, @Nullable String splitBrainProtectionName) {
