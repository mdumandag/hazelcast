 ...
 */
@Generated("affa16a2df2f075fff45693e1131aa1c")
public final class ClientAuthenticationCodec {
    ...
    public static ClientMessage encodeRequest(String clusterName, @Nullable String username, @Nullable String password, @Nullable java.util.UUID uuid, String clientType, byte serializationVersion, String clientHazelcastVersion, String clientName, java.util.Collection<String> labels) {
