 ...
 */
@Generated("f286841c554957f9198fe3bb0d2fa840")
    ...
    public abstract static class AbstractEventHandler {
        ...
        public void handle(ClientMessage clientMessage) {
            ...
            if (messageType == EVENT_PARTITIONS_VIEW_MESSAGE_TYPE) {
                ...
                java.util.Collection<java.util.Map.Entry<java.util.UUID, java.util.List<Integer>>> partitions = EntryListUUIDListIntegerCodec.decode(iterator);
         ...
         */
        public abstract void handlePartitionsViewEvent(int version, java.util.Collection<java.util.Map.Entry<java.util.UUID, java.util.List<Integer>>> partitions);
    }
}
