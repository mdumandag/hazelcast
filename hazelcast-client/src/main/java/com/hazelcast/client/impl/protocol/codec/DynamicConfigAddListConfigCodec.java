 ...
 */
@Generated("9b95b5f685034079f8dd0b9205b8b94b")
public final class DynamicConfigAddListConfigCodec {
    ...
    public static ClientMessage encodeRequest(String name, @Nullable java.util.Collection<com.hazelcast.client.impl.protocol.task.dynamicconfig.ListenerConfigHolder> listenerConfigs, int backupCount, int asyncBackupCount, int maxSize, boolean statisticsEnabled, @Nullable String splitBrainProtectionName, String mergePolicy, int mergeBatchSize) {
