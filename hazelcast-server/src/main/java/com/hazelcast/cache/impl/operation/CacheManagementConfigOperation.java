 ...
 * @see ICacheService#setManagementEnabled(com.hazelcast.config.CacheConfig, String, boolean)
 * @see ICacheService#setStatisticsEnabled(com.hazelcast.config.CacheConfig, String, boolean)
 */
