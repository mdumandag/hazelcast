...
public final class CacheProxyUtil {
     ...
     * @param <K>    the type of key.
     * @param <V>    the type of value.
     * @throws NullPointerException if key or any value is null.
     */
     ...
     * @param <K>  the type of key.
     * @throws NullPointerException if provided key set is null.
     */
     ...
     * @param <K> the type of key.
     * @param <V> the type of value.
     * @throws NullPointerException if provided map contains a null key or value in the map.
     */
