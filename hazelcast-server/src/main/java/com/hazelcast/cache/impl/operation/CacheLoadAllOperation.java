...
/**
 * Loads all entries of the keys to partition record store {@link ICacheRecordStore}.
 * <p>{@link CacheLoadAllOperationFactory} creates this operation.</p>
 * <p>Functionality: Filters out the partition keys and calls
 * {@link ICacheRecordStore#loadAll(Set keys, boolean replaceExistingValues)}.</p>
 */
