 ...
 */
@Generated("29acc2fb9943079c3a57fc8ec5ee3c9f")
public final class ServerCacheFetchNearCacheInvalidationMetadataCodec {
    //hex: 0x131E00
    ...
    private ServerCacheFetchNearCacheInvalidationMetadataCodec() {
    }
    ...
    public static ClientMessage encodeResponse(java.util.Collection<java.util.Map.Entry<String, java.util.List<java.util.Map.Entry<Integer, Long>>>> namePartitionSequenceList, java.util.Collection<java.util.Map.Entry<Integer, java.util.UUID>> partitionUuidList) {
