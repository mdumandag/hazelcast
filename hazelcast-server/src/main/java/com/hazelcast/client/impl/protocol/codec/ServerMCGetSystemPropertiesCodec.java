 ...
 */
@Generated("ef7fca62d4f020078ad06cd753d526a4")
public final class ServerMCGetSystemPropertiesCodec {
    //hex: 0x200A00
    ...
    private ServerMCGetSystemPropertiesCodec() {
    }


    public static ClientMessage encodeResponse(java.util.Collection<java.util.Map.Entry<String, String>> systemProperties) {
