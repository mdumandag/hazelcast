 ...
 */
@Generated("2be2e50d32f6948f66a26fa358a0f9d3")
public final class ServerMCReadMetricsCodec {
    //hex: 0x200100
    ...
    private ServerMCReadMetricsCodec() {
    }
    ...
    public static ClientMessage encodeResponse(java.util.Collection<java.util.Map.Entry<Long, byte[]>> elements, long nextSequence) {
