...
public class AddExecutorConfigMessageTask
        extends AbstractAddConfigMessageTask<ServerDynamicConfigAddExecutorConfigCodec.RequestParameters> {
    ...
    @Override
    protected ServerDynamicConfigAddExecutorConfigCodec.RequestParameters decodeClientMessage(ClientMessage clientMessage) {
        return ServerDynamicConfigAddExecutorConfigCodec.decodeRequest(clientMessage);
    }

    @Override
    protected ClientMessage encodeResponse(Object response) {
        return ServerDynamicConfigAddExecutorConfigCodec.encodeResponse();
    }
