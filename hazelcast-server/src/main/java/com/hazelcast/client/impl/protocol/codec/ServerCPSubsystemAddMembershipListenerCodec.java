 ...
 */
@Generated("cc77a3bff2250723f87724b3d7dbc730")
public final class ServerCPSubsystemAddMembershipListenerCodec {
    //hex: 0x220100
    ...
    private ServerCPSubsystemAddMembershipListenerCodec() {
    }
    ...
    public static ClientMessage encodeMembershipEventEvent(com.hazelcast.cp.CPMember member, byte type) {
        ClientMessage clientMessage = ClientMessage.createForEncode();
        Frame initialFrame = new Frame(new byte[EVENT_MEMBERSHIP_EVENT_INITIAL_FRAME_SIZE], UNFRAGMENTED_MESSAGE);
