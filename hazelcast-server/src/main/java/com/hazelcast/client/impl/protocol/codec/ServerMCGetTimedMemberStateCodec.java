 ...
 */
@Generated("f1cacc47bf22983b05dcc06dca38e593")
public final class ServerMCGetTimedMemberStateCodec {
    //hex: 0x200B00
    ...
    private ServerMCGetTimedMemberStateCodec() {
    }


    public static ClientMessage encodeResponse(@Nullable String timedMemberStateJson) {
