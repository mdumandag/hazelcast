...
public class MetricsConfigHelperBase {
    MetricsConfigHelperBase() {
    }
    ...
    static void tryOverride(HazelcastProperty property, Function<String, String> getPropertyValueFn,
